...
datasetName12 = 'ichi_dataset12'; % データセットの名前を指定
datasetName23 = 'ichi_dataset23';
datasetName13 = 'ichi_dataset13';
dataName = 'ichi';
csvFilename = 'ichi_label.csv';
labelName = 'stimulus';
...
disp(['Accuracy', '：', num2str(meanAccuracy23 * 100), '%']);
