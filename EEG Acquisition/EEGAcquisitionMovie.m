...
params.experiment.labelName = 'stimulus';
...
labelName = params.experiment.labelName;
...
preprocessedData = preprocessData(eegData, params.eeg.Fs, params.eeg.filtOrder, params.eeg.minf, params.eeg.maxf);

% ラベル作成
if ~exist('stimulusStart', 'var') || isempty(stimulusStart)
    % CSVファイルからデータを読み込む
    videoStarts = readmatrix(csvFilename);
    labels = readmatrix('VRLocomotion_Training.csv');
